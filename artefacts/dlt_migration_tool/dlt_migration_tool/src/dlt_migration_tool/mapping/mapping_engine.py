    ...
    def get_mapping_rules(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "bronze_quarantine_table": {
                "type": "conditional",
                "condition": "value_exists",
                "target": "quarantineMode",
                "value": "table"
            }
        }
...
class MappingEngine:
    ...
    def _handle_special_cases(self, 
        ...
        if data_level == "bronze":
            target_config["dataQualityExpectationsEnabled"] = True
            ...
            # Add quarantine settings
            target_config["quarantineMode"] = "table"
            target_config["quarantineTargetDetails"] = {
                "targetFormat": "delta"
            }
